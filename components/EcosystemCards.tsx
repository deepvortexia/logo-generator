...
const tools = [
  ...
  { name: 'Image Gen',    icon: '🎨', desc: 'AI artwork',                   href: 'https://images.deepvortexai.art',    isCurrent: false },
  { name: 'Logo Gen',     icon: '🛡️', desc: 'AI logo creation',             href: 'https://logo.deepvortexai.art',      isCurrent: true  },
